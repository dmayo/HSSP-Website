...
$body             = "David Mayo and Albert Shaw invite you to try out File Manager. This service is completely free and allows you to store your files online and share them with your friends. This project is still in development so please email any feedback to <a href=\"malto:filemanagerdmas@gmail.com\">filemanagerdmas@gmail.com</a>. Please use Firefox as there may be some compatability issues with other browsers. 
<br>
<br>
...
$mail->FromName   = "David Mayo and Albert Shaw";
$mail->Subject    = "File Manager Invitation";
$mail->AltBody    = "You have been invited to try out File Manager, 
Go to the following link to create your account  
".$url."register.php?userid=$code
